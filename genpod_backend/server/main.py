...
from .api.workspace.configure import prompt_routes
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:3000",  # Dev direct
        "https://localhost",      # Through Traefik
    ],
...
app.include_router(create_project.router, prefix="/api") 
